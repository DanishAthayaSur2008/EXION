        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl p-8 text-white">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">Ekstrakurikuler Robotik</h1>
                <p className="text-blue-100 text-lg">Programming, Elektronik, dan Artificial Intelligence</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-6">
                  Ekstrakurikuler Robotik adalah wadah bagi siswa untuk mempelajari teknologi robotika, pemrograman, dan
                  elektronik. Kami fokus pada pengembangan keterampilan STEM melalui proyek-proyek praktis dan kompetisi
                  robotika tingkat regional hingga nasional.
                </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {members.map((member) => (
                      <div key={member.id} className="flex items-center gap-3 p-4 bg-muted rounded-lg">
                        <img
                          src={member.photoUrl || "/placeholder.svg?height=40&width=40&query=student avatar"}
                          alt={member.name}
                        ...
                        <Badge variant="outline">{member.status === "active" ? "Aktif" : "Tidak Aktif"}</Badge>
                      </div>
                    ))}
                  </div>
                ) : (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {activities.map((activity) => (
                      <div key={activity.id} className="bg-muted rounded-lg overflow-hidden">
                        <img
                          src={activity.image || "/placeholder.svg?height=200&width=300&query=robotics activity"}
                          alt={activity.title}
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center justify-between text-sm text-muted-foreground">
                            <div className="flex items-center gap-1">
                              ...
                              <span>{getDateFromFirestore(activity.date).toLocaleDateString("id-ID")}</span>
                            </div>
                            <div className="flex items-center gap-1">
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground">Lab Komputer & Lab Robotik</p>
                <p className="text-sm text-muted-foreground mt-2">Lantai 2, Gedung Utama</p>
              </CardContent>
            </Card>
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <span className="text-xs text-muted-foreground">
                            {getDateFromFirestore(achievement.date).getFullYear()}
                          </span>
                        </div>
                      </div>
                    ))}
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Guru Informatika</p>
                  <p className="text-sm text-muted-foreground">📞 0812-3456-7890</p>
                  <p className="text-sm text-muted-foreground">✉️ ahmad.tech@sman1.sch.id</p>
                </div>
              </CardContent>
            </Card>
          </div>
