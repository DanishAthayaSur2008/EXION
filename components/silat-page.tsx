        ...
        <div className="mb-8">
          ...
          <div className="bg-gradient-to-r from-red-600 to-orange-500 rounded-2xl p-8 text-white">
            <div className="flex items-center gap-6">
              ...
              <div>
                <h1 className="text-4xl font-bold mb-2">Ekstrakurikuler Pencak Silat</h1>
                <p className="text-red-100 text-lg">Seni Bela Diri Tradisional Indonesia</p>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-muted-foreground mb-6">
                  Pencak Silat adalah seni bela diri tradisional Indonesia yang mengajarkan teknik pertahanan diri,
                  disiplin, dan nilai-nilai budaya. Ekstrakurikuler ini bertujuan melestarikan warisan budaya sambil
                  mengembangkan karakter, mental, dan fisik siswa melalui latihan yang terstruktur.
                </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {activities.map((activity) => (
                      <div key={activity.id} className="bg-muted rounded-lg overflow-hidden">
                        <img
                          src={activity.image || "/placeholder.svg?height=200&width=300&query=pencak silat activity"}
                          alt={activity.title}
                        ...
                        <div className="p-4">
                          ...
                          <div className="flex items-center justify-between text-sm text-muted-foreground">
                            <div className="flex items-center gap-1">
                              ...
                              <span>{activity.date.toLocaleDateString("id-ID")}</span>
                            </div>
                            <div className="flex items-center gap-1">
                    ...
                    {achievements.slice(0, 3).map((achievement) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-2">
                          ...
                          <span className="text-xs text-muted-foreground">{achievement.date.getFullYear()}</span>
                        </div>
                      </div>
                    ))}
                  </div>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-muted-foreground">Pelatih Pencak Silat</p>
                  <p className="text-sm text-muted-foreground">📞 0815-6789-0123</p>
                  <p className="text-sm text-muted-foreground">✉️ dedi.silat@sman1.sch.id</p>
                </div>
              </CardContent>
            </Card>
          </div>
